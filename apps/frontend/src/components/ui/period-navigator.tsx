...
export function PeriodNavigator({
  ...
  return (
    <div
      className={`flex h-12 select-none items-center justify-between gap-0.5 rounded-md border border-outline-variant/30 bg-surface px-1.5 shadow-sm ${className}`}
    >
      <button
        type="button"
        onClick={onPrevious}
