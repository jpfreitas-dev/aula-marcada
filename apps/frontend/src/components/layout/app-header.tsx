...
export function AppHeader() {
  ...
  if (variant === 'profile') {
    return (
      <header className="sticky top-0 z-40 flex items-center gap-1 bg-purple-900 px-margin-main pb-3 pt-[max(0.75rem,env(safe-area-inset-top))] text-white shadow-sm">
        <Link
          to={profileBackTo}
  ...
  return (
    <header className="sticky top-0 z-40 flex flex-col gap-2 bg-purple-900 px-margin-main pb-2 pt-[max(1rem,env(safe-area-inset-top))] text-white shadow-sm">
