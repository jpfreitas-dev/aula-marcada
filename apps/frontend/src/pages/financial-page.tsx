...
function SummaryCard({
  ...
  return (
    <div className="rounded-md border border-outline-variant/30 bg-white p-4 shadow-sm">
...
export function FinancialPage() {
  ...
  return (
    <div className="flex flex-col gap-stack-md">
      <div className="flex w-full rounded-md bg-bg-subtle p-1">
      ...
      <section className="rounded-md border border-outline-variant/30 bg-white p-4 shadow-sm">
